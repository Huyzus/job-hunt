...
Job-Hunt supports Codex through the root `AGENTS.md` file.
...
- `Evaluate this job URL with Job-Hunt and run the full pipeline.`
- `Scan my configured portals for new roles that match my profile.`
- `Generate the tailored ATS PDF for this role using Job-Hunt.`
...
Job-Hunt modes and scripts rather than introducing a parallel automation
layer.
