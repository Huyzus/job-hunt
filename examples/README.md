...
Reference files that demonstrate job-hunt data formats and conventions. None of these are used at runtime -- they exist so you can see the expected structure before creating your own files.
...
These files are read-only references. To set up your own job-hunt instance:
