#!/usr/bin/env node
/**
 * gemini-eval.mjs — Gemini-powered Job Offer Evaluator for job-hunt
 *
...
const PATHS = {
  ...
  // Canonical skill definition file path (SKILL.md router, not an invocation path)
  skillDef: join(ROOT, '.claude', 'skills', 'job-hunt', 'SKILL.md'),
  cv:       join(ROOT, 'cv.md'),
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║           job-hunt — Gemini Evaluator (free-tier)             ║
╚══════════════════════════════════════════════════════════════════╝
...
// ---------------------------------------------------------------------------
const systemPrompt = `You are job-hunt, an AI-powered job search assistant.
...
// ---------------------------------------------------------------------------
console.log('\n' + '═'.repeat(66));
console.log('  JOB-HUNT EVALUATION — powered by Google Gemini');
