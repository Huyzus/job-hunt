...
Thanks for your interest in contributing! Job-Hunt is built with Claude Code, and you can use it for development too.
...
- **PRs that enable auto-submitting applications** without human review. job-hunt is a decision-support tool, not a spam bot.
