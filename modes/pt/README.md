# job-hunt -- Modos em Português BR (`modes/pt/`)

Esta pasta contém as traduções em português brasileiro dos principais modos do job-hunt para candidatos que buscam vagas no mercado brasileiro ou em empresas que operam em português.
...
O job-hunt não tem um "switch de idioma" como flag de código. Em vez disso, existem dois caminhos:
