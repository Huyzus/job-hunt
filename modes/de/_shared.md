# Geteilter Kontext -- job-hunt (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle job-hunt-Modi
     in der deutschen Variante. Bevor du job-hunt verwendest, MUSST du:
