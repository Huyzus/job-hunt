...
Interactive mode for when the candidate is filling out an application form in Chrome. Reads what is on the screen, loads the previous context of the offer, and generates personalized answers for each question in the form.
...
5. **job-hunt proof point**: Include in "Additional info" if there is a field for it
...
3. Suggest next step: `/job-hunt outreach` for LinkedIn outreach
