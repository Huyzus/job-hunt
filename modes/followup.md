...
- Suggest the user run `/job-hunt outreach {company}` to find the right person first
...
> - Trying a different contact via `/job-hunt outreach`
...
**To:** {email or "No contact found — run `/job-hunt outreach` first"}
