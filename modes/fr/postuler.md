...
5. **job-hunt proof point** : inclure dans "Informations complementaires" si un tel champ existe
...
3. Suggerer l'etape suivante : `/job-hunt contacto` pour du LinkedIn outreach vers le hiring manager
