...
Traite les URLs d'offres accumulees dans `data/pipeline.md`. Le candidat ajoute des URLs quand il veut et lance ensuite `/job-hunt pipeline` pour toutes les traiter d'un coup.
