# job-hunt -- Modes francophones (`modes/fr/`)

Ce dossier contient les traductions francaises des principaux modes job-hunt pour les candidats qui ciblent le marche francophone (France, Belgique, Suisse romande, Luxembourg, Quebec).
